	...
	<nav class="nav-section" id="myHeader">
		<div class="container">
			...
			<ul class="main-menu">
				...
				<li <?php if($active=="profil"){ ?>class="active"<?php } ?>><a href="<?=base_url('home/profil');?>">Profil</a></li>
				<li <?php if($active=="admission"){ ?>class="active"<?php } ?>><a href="<?=base_url('home/admission');?>">Pendaftaran</a></li>
				<li <?php if($active=="galeri"){ ?>class="active"<?php } ?>><a href="<?=base_url('home/galeri');?>">Galeri</a></li>
				<li <?php if($active=="blog"){ ?>class="active"<?php } ?>><a href="<?=base_url('home/blog');?>">Blog</a></li>
				<li <?php if($active=="kontak"){ ?>class="active"<?php } ?>><a href="<?=base_url('home/kontak');?>">Kontak</a></li>
			</ul>
		</div>
	</nav>
	<!-- Header section end -->