					...
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								...
								<a href="https://api.whatsapp.com/send?phone=628123456789&text=Hallo%20Agan%20Baik"><div class="site-btn">Chat Whatsapp</div></a>
							</div>
						</div>
					</div>
				</div>
...
<section class="courses-section spad">
	<div class="container">
		<div class="section-title text-center">
			...
			<p>Menyediakan Beberapa Program Pelatihan yang Bisa Anda Pilih</p>
		</div>
		<div class="row">
			<?php 
		...
		<div class="row">
			<div class="col-lg-5">
				<div class="section-title text-white">
					<h3>Tujuan</h3>
					<p>Apa yang diperoleh dengan mengikuti pelatihan ini?</p>
				</div>
				<div class="enroll-list text-white">
					<div class="enroll-list-item">
						<span>1</span>
						<p>Mahasiswa memperoleh ilmu pengetahuan dan keterampilan yang berkualitas.</p>
					</div>
					<div class="enroll-list-item">
						<span>2</span>
						<p>Mahasiswa menjadi tenaga mandiri yang mampu menciptakan pekerjaan berdasarkan ilmu pengetahuan dan keterampilan yang dimilikinya.</p>
					</div>
					<div class="enroll-list-item">
						<span>3</span>
						<p>Mencetak tenaga profesional untuk bekerja dilingkungan industri perhotelan dalam dan luar negeri serta kapal pesiar luar negeri.</p>
					</div>
					<div class="enroll-list-item">
						<span>4</span>
						<p>Mahasiswa menjadi tenaga profesional yang mampu bersaing di dalam dan luar negeri.</p>
					</div>
				</div>
			</div>
...
<section class="service-section spad">
	<div class="container services">
		<div class="section-title text-center">
			...
			<p>Kami menyediakan sarana dan prasarana dalam menunjang kegiatan pelatihan</p>
		</div>
		<div class="row">
...
<section class="service-section spad">
	<div class="container services">
		<div class="section-title text-center">
			<h3>Kerja Sama</h3><br><br>
			<button class="btn btn-primary">Dalam dan Luar Negeri</button>
		</div>
				...
				<div class="col-xl-6">
					<div class="blog-item">
						...
						<div class="blog-content">
							<a href="<?=base_url('home/blog_read/'.$blog->id);?>"><h4><?=$blog->judul;?></h4></a>
							<div class="blog-meta">
